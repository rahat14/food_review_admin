...
?>
    ...
    if (isset($_GET['edit_job_circular'])) {
        ...
        $edit_id = $_GET['edit_job_circular'];

        $edit_p_cat_query = "select * from job_circular_db where id='$edit_id'";

        $run_edit = mysqli_query($con, $edit_p_cat_query);

        $row_edit = mysqli_fetch_array($run_edit);

        $p_SUB_cat_id = $row_edit['sub_cat_id'];
        ...
        $get_ma = "select * from job_circular_category where id = $store_merchant_id ";
                ...
                <div class="card-body  pad">
                    ...
                    <form class="form-horizontral" action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <label class="col-md-6 control-label"> Update The Rank (+100) : </label>

                            <div class="col-md-5">

                                <input type="number" name="rank" class="form-control" required value="<?php echo $rank; ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="checkbox" name="sub_category" value="Yes" <?php
    ...
    if (isset($_POST['submit'])) {
        ...
        $insert_store = "UPDATE  job_circular_db  set  title =  '$store_title'  ,image  ='$store_image'  ,pdf ='$circular_pdf' ,description ='$store_desc' , cat_id ='$store_merchant_id' , sub_cat_id  = $p_SUB_cat_id  , keywords ='$keywords'  , image2 = '$store_image2' , image3 = '$store_image3' , rank = $rank where  id = $edit_id";

        $run_store = mysqli_query($con, $insert_store);

        if ($run_store) {

            echo "<script>alert(Circular  Has Been Updated')</script>";
